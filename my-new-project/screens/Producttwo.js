...
export class Producttwo extends Component {
  ...
  alertmsg=()=>{
    ...
    AsyncStorage.getItem('sa_cart').then((out1)=>{
      ...
      if(out1==null){ //first time
        ...
        AsyncStorage.getItem('sa_cart').then((res)=>{
  ...
  componentWillMount(){
    this.setState({title:"new Shirt", price:"$500",offer:"43%"})
  }
...
<View
            ...
            >
             <Image source={{uri: 'https://s-media-cache-ak0.pinimg.com/originals/c2/1d/aa/c21daa62cffcf32aecc85583c829838f.jpg'}} style={{height: 350, width: 240,marginLeft:55}}/>
            </View>
            <View
              style={[styles.containerHorizontal]}
            >
...
//       this.setState({title:res[0].title, price:res[0].price})
//     })
//   }
...
//   // async deleteItem(){
//   //   AsyncStorage.removeItem('sa_cart')
//   // }
...
//     <Text style={styles.logbutton}>{this.state.title}</Text>
//     <Text style={styles.logbutton}>{this.state.price}</Text>
//     <Text style={styles.logbutton}>{this.state.offer}</Text>
// </TouchableOpacity>
//       </View>
//     );
//   }
