...
export class Individual extends Component {
      ...
      if(out1==null){ //first time
          ...
          AsyncStorage.setItem('sa_cart',JSON.stringify(newCart))
            ...
            AsyncStorage.getItem('sa_cart').then((res)=>{
              ...
              AsyncStorage.removeItem('sa_cart').then(()=>{
                let item= {title:"new shirt", price:"300"}
                 newCart.push(...res1,item) // [{}//res1, {}//item]
                 AsyncStorage.setItem('sa_cart',JSON.stringify(newCart))      
              })
            })
      }
  ...
  componentWillMount(){
    ...
    // console.log(this.props.navigation.getParam('shirt'))
  }
...
<View
            ...
            >
             <Image source={{uri: this.state.image}} style={{height: 350, width: 240,marginLeft:55}}/>
            </View>
            <View
              style={[styles.containerHorizontal]}
            >
